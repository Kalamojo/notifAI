...
def actualStuff():
    ...
    print('Prediction: {}'.format(summary.generations[0].text.split("--")[0]))
    ...
    bullets = co.generate(
      ...
      stop_sequences=[],
      return_likelihoods='NONE')
    print('Prediction: {}'.format(bullets.generations[0].text.split("--")[0]))
    response = summary.generations[0].text.split('"')[0] + "\n\n" + bullets.generations[0].text.split("\n\n")[0].split("--")[0]
